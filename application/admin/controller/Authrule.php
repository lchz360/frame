...
class Authrule extends Right implements curdInterface
{
    /**
     * 特别说明
     * Common中的文件不能直接修改！！！！
    ...
    protected $indexField = ['id','name','title','type','status','pid','condition','faicon','sort'];  //查，字段名
    protected $addField   = ['id','name','title','type','status','pid','condition','faicon','sort'];    //增，字段名
    protected $editField  = ['id','name','title','type','status','pid','condition','faicon','sort'];   //改，字段名
